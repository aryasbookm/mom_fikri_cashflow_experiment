...
class OcrImportAuditInfo {
  const OcrImportAuditInfo({
    required this.hash,
...
class OcrImportAuditService {
  static const String _recordsKey = 'ocr_import_audit_records_v1';
  static const int _maxRecords = 100;

  static Future<OcrImportAuditInfo?> findRecentDuplicate(
    String hash, {
    int windowHours = 72,
  }) async {
